# -*- coding: utf-8 -*-
"""Segment-Anything-Model(SAM) Assignment.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18DMYtdMHjbj9cpEOjWkpPl0htjvKGiZq
...
IMAGE_NAME = "/content/drive/MyDrive/5000SementicSegmentation/images/12.png"
...
grid_rows = 8
grid_cols = (len(masks) + grid_rows - 1) // grid_rows  # Ceiling division for grid columns

sv.plot_images_grid(
    images=masks,
    grid_size=(grid_rows, grid_cols),  # Dynamically adjusted grid size
    size=(16, 16)
)
...
IMAGE_NAME = "/content/drive/MyDrive/12.jpeg"
IMAGE_PATH = os.path.join(HOME, "data", IMAGE_NAME)
